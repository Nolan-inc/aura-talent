...
import { ChevronLeft, MapPin, Clock, Users, Mail, Phone, FileText, Calendar } from 'lucide-react'
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                  ...
                  <button className="w-full mt-6 px-6 py-3 bg-white text-gray-900 hover:bg-gray-100 rounded-full font-medium transition-colors">
                    エントリーする
                  </button>
                </div>
              </div>
